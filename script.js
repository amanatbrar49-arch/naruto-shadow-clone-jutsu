/* ============================================================
   ...
   NOTE: the MediaPipe library is loaded with a dynamic import()
   inside init(), deliberately NOT as a top-level static import.
   A static import that fails (blocked CDN, network filter, etc.)
   can silently kill the whole module in some browsers with zero
   visible error. Dynamic import() lets us catch that failure and
   show it on screen instead of hanging forever.
   ============================================================ */
...
async function setupHandLandmarker() {
  loadingText.textContent = 'Downloading MediaPipe library…';
